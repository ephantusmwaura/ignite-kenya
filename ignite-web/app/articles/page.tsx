...
import { ArrowUpRight, Newspaper, Loader2 } from "lucide-react";
        ...
        <main className="min-h-screen py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <header className="mb-24 text-center max-w-3xl mx-auto">
                <motion.div
                    ...
                    className="w-20 h-20 bg-blue-100 text-blue-600 rounded-3xl flex items-center justify-center mx-auto mb-8"
                >
                ...
                >
                    In-depth analysis, news, and perspectives on art, youth leadership, and social impact.
                </motion.p>
            </header>
            ...
            {loading ? (
                ...
                <div className="text-center py-40 bg-secondary/30 rounded-[64px] border border-dashed border-border">
                    <Newspaper className="w-20 h-20 text-muted-foreground opacity-20 mx-auto mb-6" />
