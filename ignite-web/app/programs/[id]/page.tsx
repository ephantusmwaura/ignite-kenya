...
import { ArrowLeft, Loader2, Calendar, MapPin, ExternalLink, GraduationCap, Users, Paintbrush, LucideIcon } from "lucide-react";
    ...
    if (!program) {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
                ...
                <Link href="/programs" className="text-primary flex items-center gap-2">
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-32 pb-6 px-8 lg:px-24">
                <Link href="/programs" className="group inline-flex items-center gap-2 bg-white px-5 py-2.5 rounded-full border border-gray-100 shadow-sm hover:shadow-md hover:border-primary/20 transition-all">
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform text-gray-600" />
                    <span className="text-sm font-medium text-gray-600 group-hover:text-primary transition-colors">Back to Programs</span>
                </Link>
            </div>
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-8 text-sm text-muted-foreground border-t border-gray-100 pt-8">
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className="font-medium">{new Date(program.created_at).toLocaleDateString(undefined, { year: 'numeric', month: 'long' })}</span>
                            </div>
                            <div className="flex items-center gap-2.5">
                    ...
                    >
                        {program.image_url ? (
                            ...
                            <div className="w-full h-full bg-neutral-50 flex items-center justify-center">
                                <Icon className="w-24 h-24 text-muted-foreground/5" />
                            </div>
                        )}
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-4 lg:start-9 mt-12 lg:mt-0">
                        <div className="sticky top-32">
                            <StarRating targetId={program.id} targetType="program" />
                        </div>
                    </div>
                </div>
            </main>
                ...
                <div className="max-w-7xl mx-auto px-8 lg:px-24">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                        <div className="max-w-md">
                            <h3 className="text-2xl font-bold mb-4">Empower this program</h3>
                            <p className="text-gray-500">
                                Support <strong>{program.title}</strong> to help us reach more youth in Nakuru. Every contribution makes a difference.
                            </p>
                        </div>

                        <div className="flex flex-wrap justify-center md:justify-end gap-4 w-full md:w-auto">
                            <Link
                                href="https://www.mchanga.africa/"
                                target="_blank"
